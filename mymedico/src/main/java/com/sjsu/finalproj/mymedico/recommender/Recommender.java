...
public class Recommender {
	 public static String jdbc_url="jdbc:mysql://meddbinstance.cozrev6gggap.us-west-1.rds.amazonaws.com/MedDB";
	 public static String jdbc_url1="jdbc:mysql://meddbinstance.cozrev6gggap.us-west-1.rds.amazonaws.com/MedDB";
	...
	public int recommender_function(String email_id) throws Exception	{
   	  ...
   	  while(mean_array_sort[row_count][1] != 3)	{
   	  ...
   	  for(int i=0;i<5;i++)	{
   		  ...
   		  if(mean_array_sort[i][1] == 5)
   			  mean_array[4][2] = mean_array_sort[i][2];
   	  }
   	  ...
   	  stmt2.executeUpdate("Insert into recommend(id,email_id,diabetese,hypertension,obesity,healthy,unhealthy) values("+recommender_id+",'"+email_id+"',"+mean_array[4][2]+","+mean_array[3][2]+","+mean_array[1][2]+","+mean_array[2][2]+","+mean_array[0][2]+")");
   	//  id++;
