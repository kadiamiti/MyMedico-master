...
public class User {
	...
	private String familyHypertension;
	...
	public String getCaffeineHabits() {
	...
	public String getHaemoglobinContent() {
		return haemoglobinContent;
	}
	public void setHaemoglobinContent(String haemoglobinContent) {
		this.haemoglobinContent = haemoglobinContent;
	}
	public String getFamilyHypertension() {
		return familyHypertension;
	}
	public void setFamilyHypertension(String familyHypertension) {
